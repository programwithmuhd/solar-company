<div class="container mx-auto mt-6">
    <ul class="flex flex-wrap md:flex-row justify-evenly items-center box-border">
        ...
        <li class="p-2"><a class="inline-block uppercase px-4 py-3 box-border text-lg text-gray-900 font-bold hover:border-b-4 border-b-primary active:border-b-primary" href="#">Video</a></li>
        ...
        <li class="p-2"><a class="inline-block uppercase px-4 py-3 box-border text-lg text-gray-900 font-bold hover:border-b-4 border-b-primary active:border-b-primary" href="#">Faq</a></li>
    </ul>
</div>